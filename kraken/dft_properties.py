...
'''Functions for extracting properties from split Gaussian16 log files'''
...
def get_e_hf(streams: list[list[str]]) -> float | None:
    '''
    Gets the electronic energy from the last compressed stream of
    a Gaussian16 logfile. This stream is a list of strings!
    '''
